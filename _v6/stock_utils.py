...
class StockRenamer:
    ...
    RENAME_MAP = {
        ...
        'frgn_reg_askp_qty': '외국인등록_매도수량', 'frgn_reg_bidp_qty': '외국인등록_매수수량',
        'frgn_nreg_askp_qty': '외국인미등록_매도수량', 'frgn_nreg_bidp_qty': '외국인미등록_매수수량',
        ...
        'scrt_seln_tr_pbmn': '금융투자_매도금액', 'scrt_shnu_tr_pbmn': '금융투자_매수금액',
        'ivtr_seln_tr_pbmn': '투신_매도금액', 'ivtr_shnu_tr_pbmn': '투신_매수금액',
        'pe_fund_seln_tr_pbmn': '사모펀드_매도금액', 'pe_fund_shnu_tr_pbmn': '사모펀드_매수금액',
        'bank_seln_tr_pbmn': '은행_매도금액', 'bank_shnu_tr_pbmn': '은행_매수금액',
        'insu_seln_tr_pbmn': '보험_매도금액', 'insu_shnu_tr_pbmn': '보험_매수금액',
        'mrbn_seln_tr_pbmn': '기타금융_매도금액', 'mrbn_shnu_tr_pbmn': '기타금융_매수금액',
        'fund_seln_tr_pbmn': '연기금_매도금액', 'fund_shnu_tr_pbmn': '연기금_매수금액',
        'etc_seln_tr_pbmn': '기타법인_매도금액', 'etc_shnu_tr_pbmn': '기타법인_매수금액',
        'etc_corp_seln_tr_pbmn': '기타법인_매도금액_2', 'etc_corp_shnu_tr_pbmn': '기타법인_매수금액_2',
        'etc_orgt_seln_tr_pbmn': '기타단체_매도금액', 'etc_orgt_shnu_tr_pbmn': '기타단체_매수금액',
        'frgn_reg_askp_pbmn': '외국인등록_매도금액', 'frgn_reg_bidp_pbmn': '외국인등록_매수금액',
        'frgn_nreg_askp_pbmn': '외국인미등록_매도금액', 'frgn_nreg_bidp_pbmn': '외국인미등록_매수금액',

        # [중복 및 확인용]
        'stck_clpr_investor': '종가_확인용', 'stck_oprc_investor': '시가_확인용',
        'stck_hgpr_investor': '고가_확인용', 'stck_lwpr_investor': '저가_확인용',
        'acml_vol_investor': '거래량_확인용', 'acml_tr_pbmn_investor': '거래대금_확인용',
        'prdy_vrss_investor': '전일대비_확인용', 'prdy_vrss_sign_investor': '대비부호_확인용',
        'bold_yn': '볼드여부'
    }

    @classmethod
    def rename(cls, df):
        """데이터프레임의 컬럼명을 한글로 변경하여 반환"""
